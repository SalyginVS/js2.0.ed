...
function t10() {
  ...
  document.querySelector('div.out-10').textContent = data * 10;
}
...
function t11() {
  document.querySelector('div.out-11').textContent = document.querySelector('.i-11').value+55;
}
...
function t18() {
  ...
  document.querySelector('.out-18').innerHTML = parseFloat(a, 10);
}
...
function t19() {
  document.querySelector('.out-19').innerHTML = +(document.querySelector('.i-19-1').value) + +(document.querySelector('.i-19-2').value)
}
