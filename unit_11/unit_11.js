...
function f1() {
  d1[d1.length] = document.querySelector('.i-1').value
  showArr('.out-1', d1);
}
...
function f8() {
  let temp = [];
  temp[0] = document.querySelector('.i-8').value;
...
function f11() {
  let out = +document.querySelector('.i-11').value;
  document.querySelector('.out-11').textContent = d11.indexOf(out);
}
...
function f12() {
  ...
  document.querySelector('.out-12').textContent = ind;
}
...
function f15() {
  ...
  if (d15.indexOf(i15) == - 1) d15.push(i15);
  showArr('.out-15', d15);
}
