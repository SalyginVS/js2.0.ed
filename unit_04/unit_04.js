...
function f4() {
  let chBox = document.querySelector('.i-4');
...
function f6() {
  document.querySelector('div.out-6').innerHTML = document.querySelector('input.i-6').value;
}
...
function f7() {
  let i_7 = document.querySelector('input.i-7');
  let out = document.querySelector('.out-72');

  document.querySelector('div.out-71').innerHTML = i_7.value;

  if (i_7.value.length >= 6) {
    out.innerHTML = 1;
  } else {
    out.innerHTML = 0;
  }
...
function f9() {
  let r_9 = document.querySelector('.r-9');
  let out = document.querySelector('.out-9');

  if (r_9.checked) {
    out.innerHTML = r_9.value;
  } else {
    out.innerHTML = false;
  }
}
...
function f15() {
  let out = document.querySelector('.i-15').value;

  document.querySelector('.t-15').value = out;
...
function f16() {
  ...
  let opt = document.querySelector('.s-16');

  document.querySelector('.out-16').innerHTML = opt.value;
}
...
function f19() {
  document.querySelector('.i-19').value = document.querySelector('div.out-19').innerText;
}
