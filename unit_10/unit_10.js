...
let ar1 = ['string1', true, '12', 12, false, 1, 'string2'];
function f1() {
...
let ar2 = ['string1', true, '12', 12, false, 1, 'string2'];
...
let ar3 = ['string1', true, '12', 12, false, 1, 'string2'];
...
let ar4 = ['string1', true, '14', 12, false, 1, 'string2', 7, 8, 9, 10];
let out = '';
function f4() {
...
function f10() {
  document.querySelector('.out-10').textContent = ar10[ar10.length - 1] + ar10[0];
}
